 ...
 */
package com.saasquatch.forge_inflector_standalone;
 ...
 * ordinal form. This is inspired by the
 * <a href="http://api.rubyonrails.org/classes/Inflector.html">Inflector</a> class in
...
public class Inflector {
  ...
  public void addIrregular(String singular, String plural) {
    if (singular == null || singular.isEmpty()) {
      throw new IllegalArgumentException("singular rule");
    }
    if (plural == null || plural.isEmpty()) {
      throw new IllegalArgumentException("plural rule");
    }
  ...
  protected void initialize() {
    ...
    inflect.addUncountable("equipment", "information", "rice", "money", "species", "series", "fish",
        "sheep");
  }
